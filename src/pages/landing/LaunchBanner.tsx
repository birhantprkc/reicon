    ...
    return (
        <div className="relative z-[300] flex items-center justify-center px-10 py-1.5 bg-bg-base transition-colors duration-300">
            ...
            <span className="hidden sm:inline-flex items-center gap-2 text-[13px] text-text-base/45">
                ...
                <a href="/usage/mcp" className="hover:text-text-base/70 transition-colors cursor-pointer">
                    MCP server is live
                </a>
                <span className="text-text-base/15">·</span>
                <a href="/usage/mcp" className="text-text-base/50 hover:text-text-base/80 transition-colors underline underline-offset-2 decoration-text-base/20 cursor-pointer">
                    Get started
                </a>
            ...
            {/* Mobile */}
            <a href="/usage/mcp" className="inline-flex sm:hidden items-center gap-1.5 text-[12px] text-text-base/45 hover:text-text-base/65 transition-colors cursor-pointer">
                <SiModelcontextprotocol size={12} />
