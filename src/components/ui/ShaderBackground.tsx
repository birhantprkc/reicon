...
const DARK_COLORS: [number, number, number][] = [
  [0.05, 0.05, 0.08],       // Deep surface base
  [0.18, 0.14, 0.32],       // Soft violet shadow
  [0.42, 0.35, 0.70],       // Deep brand purple
  [0.6078, 0.5412, 0.9843], // #9B8AFB Primary Brand Accent
  [0.70, 0.62, 0.95],       // Violet glow
  [0.78, 0.70, 0.98],       // Soft violet accent
  [0.78, 0.70, 0.98],
  [0.78, 0.70, 0.98]
];

const LIGHT_COLORS: [number, number, number][] = [
  [0.96, 0.96, 0.94],       // Light surface base #f5f5f0
  [0.82, 0.74, 0.96],       // Rich light purple smoke
  [0.6078, 0.5412, 0.9843], // #9B8AFB Primary Brand Accent
  [0.48, 0.38, 0.88],       // Deep violet smoke accent
  [0.72, 0.64, 0.96],       // Vibrant lavender smoke
  [0.90, 0.88, 0.98],       // Soft lavender fade
  [0.96, 0.96, 0.94],
  [0.96, 0.96, 0.94]
];
