...
export const ROUTES = [
  ...
  },
  {
    path: '/icons',
    title: 'Icons — Reicon',
    description: 'Browse 2,700+ free, open-source SVG icons. Filter by category, copy code for React, Vue, Svelte, and HTML.',
  ...
  },
  {
    path: '/docs',
    title: 'Docs — Reicon',
    description: 'Get started with Reicon. Install and use icons in React, Vue, Svelte, Flutter, Figma, VS Code, MCP, and more.',
    ogImage: og('docs.jpg'),
    priority: '0.8',
    changefreq: 'monthly',
  },
  ...
  {
    path: '/docs/mcp',
    title: 'MCP Server & CLI — Reicon',
    description: 'Use reicon-mcp to let AI agents search 2,700+ icons, preview SVGs, and generate code. Runs as MCP server or standalone CLI.',
  ...
  {
    path: '/packages',
    title: 'Packages — Reicon',
    description: 'Install official Reicon packages for React, React Native, Vue, Svelte, Flutter, and JavaScript.',
  ...
  {
    path: '/pack',
    title: 'Icon Pack Builder — Reicon',
  ...
  },
  {
    path: '/faq',
    title: 'FAQ — Reicon',
    description: 'Answers about Reicon: license, framework support, Figma integration, icon requests, and contributions.',
    ogImage: og('faq.jpg'),
    priority: '0.7',
    changefreq: 'monthly',
  },
