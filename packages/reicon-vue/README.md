...
<p align="center">
  <b>2676+ pixel-perfect SVG icons</b> • Outline & Filled weights • Vue 3 component wrapper • Zero dependencies • MIT Licensed
</p>
...
**Reicon Vue** is the official Vue 3 package for <a href="https://reicon.dev">Reicon</a> — a free, open-source SVG icon library featuring 2676+ handcrafted, grid-aligned icons. Every component is tree-shakeable, fully TypeScript-ready, and ships with zero dependencies.
...
Browse and search all 2676+ icons at <a href="https://reicon.dev">reicon.dev</a>.
...
| [`reicon-react`](https://npmjs.com/package/reicon-react) | React components for 2676+ icons. |
| [`reicon-vue`](https://npmjs.com/package/reicon-vue) | **You are here.** Vue 3 components for 2676+ icons. |
| [`reicon-svelte`](https://npmjs.com/package/reicon-svelte) | Svelte components for 2676+ icons. |
